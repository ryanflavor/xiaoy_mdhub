...
- Test canary contract heartbeat monitoring (use rb2501 or configured contracts)
...
- Configurable canary contracts per gateway type (e.g., CTP: "rb2501", SOPT: "rb2501")
